...
// Validate checks the field values on ErrRequest with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ErrRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ErrRequest with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ErrRequestMultiError, or
// nil if none found.
func (m *ErrRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ErrRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ErrRequestMultiError(errors)
	}

	return nil
}

// ErrRequestMultiError is an error wrapping multiple validation errors
// returned by ErrRequest.ValidateAll() if the designated constraints aren't met.
type ErrRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ErrRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ErrRequestMultiError) AllErrors() []error { return m }

// ErrRequestValidationError is the validation error returned by
// ErrRequest.Validate if the designated constraints aren't met.
type ErrRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ErrRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ErrRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ErrRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ErrRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ErrRequestValidationError) ErrorName() string { return "ErrRequestValidationError" }

// Error satisfies the builtin error interface
func (e ErrRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ErrRequestValidationError{}
